...
export ROZET_USE_OPEN_CODE_TOOLS="${ROZET_USE_OPEN_CODE_TOOLS:-1}"
export ROZET_OPEN_CODE_BASE_URL="${ROZET_OPEN_CODE_BASE_URL:-http://localhost:4096}"
export ROZET_OPEN_CODE_PROVIDER="${ROZET_OPEN_CODE_PROVIDER:-}"
export ROZET_OPEN_CODE_MODEL="${ROZET_OPEN_CODE_MODEL:-}"
...
echo "[rozet-env] ROZET_USE_OPEN_CODE_TOOLS=${ROZET_USE_OPEN_CODE_TOOLS}"
echo "[rozet-env] ROZET_OPEN_CODE_BASE_URL=${ROZET_OPEN_CODE_BASE_URL}"
echo "[rozet-env] ROZET_OPEN_CODE_PROVIDER=${ROZET_OPEN_CODE_PROVIDER:-<config default>}"
echo "[rozet-env] ROZET_OPEN_CODE_MODEL=${ROZET_OPEN_CODE_MODEL:-<config default>}"
